...
import static com.uniovi.sdi2223entrega182.util.SeleniumUtils.waitLoadElementsBy;
...
public class PO_NavView extends PO_View{
    ...
    public static void clickOption(WebDriver driver, String textOption, String criterio, String targetText) {
        ...
        List<WebElement> elements = waitLoadElementsBy(driver, "@href", textOption,
                getTimeout());
        ...
        elements = waitLoadElementsBy(driver, criterio, targetText, getTimeout());
        //Tiene que haber un sólo elemento.
        Assertions.assertEquals(1, elements.size());
    }
    /**
    ...
    public static void changeLanguage(WebDriver driver, String textLanguage) {
        ...
        List<WebElement> languageButton = waitLoadElementsBy(driver, "id", "btnLanguage",
                getTimeout());
        languageButton.get(0).click();
        //Esperamos a que aparezca el menú de opciones.
        waitLoadElementsBy(driver, "id", "languageDropdownMenuButton", getTimeout());
        //CLickamos la opción Inglés partiendo de la opción Español
        List<WebElement> Selectedlanguage = waitLoadElementsBy(driver, "id", textLanguage,
                getTimeout());
        Selectedlanguage.get(0).click();
    }
    static public List<WebElement> navigateTo(WebDriver driver,String criterio, String text, int index){
        List<WebElement> elements = waitLoadElementsBy(driver,criterio,text,PO_View.getTimeout());
